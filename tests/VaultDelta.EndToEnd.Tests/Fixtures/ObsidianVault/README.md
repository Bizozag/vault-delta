...
The fixture intentionally changes `.trash/Discarded.md` and `.obsidian/workspace.json`; both must remain excluded from snapshot, patch, apply, and rollback behavior.
