...
public sealed class MainWindowViewModel : INotifyPropertyChanged
{
    ...
    private sealed class PreviewPatchWorkflowService : IPatchWorkflowService
    {
        ...
        public ValueTask<VaultDelta.Application.Apply.ApplyResult> ApplyAsync(string packagePath, string targetRoot, IReadOnlyList<VaultDelta.Application.Apply.ConflictResolution>? resolutions = null, CancellationToken cancellationToken = default, IProgress<VaultDelta.Application.Apply.TransactionProgress>? progress = null) => ValueTask.FromException<VaultDelta.Application.Apply.ApplyResult>(Error());
        public ValueTask<VaultDelta.Application.Apply.RollbackResult> RollbackAsync(string journalPath, CancellationToken cancellationToken = default, IProgress<VaultDelta.Application.Apply.TransactionProgress>? progress = null) => ValueTask.FromException<VaultDelta.Application.Apply.RollbackResult>(Error());
    }
}
