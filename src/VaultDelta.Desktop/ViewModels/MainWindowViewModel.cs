...
public sealed class MainWindowViewModel : INotifyPropertyChanged
{
    ...
    private sealed class PreviewPatchWorkflowService : IPatchWorkflowService
    {
        ...
        public ValueTask<VaultDelta.Application.Apply.ApplyResult> ApplyAsync(string packagePath, string targetRoot, IReadOnlyList<VaultDelta.Application.Apply.ConflictResolution>? resolutions = null, CancellationToken cancellationToken = default) => ValueTask.FromException<VaultDelta.Application.Apply.ApplyResult>(Error());
