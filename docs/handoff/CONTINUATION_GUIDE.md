...
./scripts/publish-windows.ps1 -Version 0.1.2
```
...
./scripts/publish-macos.sh --version 0.1.2
```
...
plutil -lint "artifacts/releases/macos/VaultDelta-0.1.2-osx-arm64/Vault Delta.app/Contents/Info.plist"
file "artifacts/releases/macos/VaultDelta-0.1.2-osx-arm64/Vault Delta.app/Contents/MacOS/VaultDelta"
file "artifacts/releases/macos/VaultDelta-0.1.2-osx-x64/Vault Delta.app/Contents/MacOS/VaultDelta"
```
